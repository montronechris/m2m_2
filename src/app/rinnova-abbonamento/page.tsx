                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              className="w-[42px] h-[52px] rounded-xl text-center text-[20px] font-bold font-mono uppercase focus:outline-none transition-all duration-200 caret-transparent"
                              style={{
                                background: isFilled
