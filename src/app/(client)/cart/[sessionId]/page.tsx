...
useEffect(() => {
  ...
  if (items.length === 0) {
    return (
      <div style={{ minHeight: "100vh", background: T.bgGradient, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 24, padding: "40px 28px", maxWidth: 360, width: "100%", textAlign: "center", backdropFilter: "blur(12px)" }}>
          <div style={{ width: 72, height: 72, borderRadius: "50%", background: T.accentBg, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
          ...
          <Link href={menuHref}>
            <button style={{ width: "100%", padding: "13px", borderRadius: 12, background: T.btnBg, border: "none", color: "#fff", fontWeight: 700, fontSize: 15, cursor: "pointer", boxShadow: T.btnShadow }}>
              Sfoglia il menu
            </button>
          </Link>
        </div>
  ...
  // ── RENDER PRINCIPALE ────────────────────────────────────────────────────────
  return (
    <div style={{ minHeight: "100vh", background: T.bgGradient, color: T.text, fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <style>{`
      ...
      <div style={{ maxWidth: 560, margin: "0 auto", padding: "20px 16px 140px" }}>
        ...
        {/* Errore */}
        {error && (
          <div style={{ background: T.dangerBg, border: `1px solid rgba(239,68,68,0.2)`, borderRadius: 14, padding: "13px 16px", marginBottom: 16, display: "flex", gap: 10, alignItems: "flex-start", animation: "fadeUp 0.2s ease" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, marginBottom: 12 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
                    ...
                    <button
                      ...
                      style={{ background: "transparent", border: "none", cursor: "pointer", color: T.border, padding: 4, borderRadius: 8, display: "flex", transition: "color 0.15s" }}
