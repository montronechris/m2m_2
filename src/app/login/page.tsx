...
import { Mail, Lock, ArrowLeft, Shield, User, Loader2, AlertCircle, UserPlus } from "lucide-react";
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center transition-colors duration-300 ${
        isLight
          ? "bg-gradient-to-br from-gray-50 via-white to-green-50/30"
          : "bg-gradient-to-br from-gray-900 via-gray-800 to-black"
      } p-4`}
    >
      <div
        className={`p-8 rounded-3xl shadow-xl w-full max-w-md border transition-colors duration-300 ${
      ...
      >
        ...
        <div className="text-center mb-8">
          <div
            className={`w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center shadow-lg transition-colors duration-300 ${
              isLight
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label
              className={`block text-xs font-bold uppercase mb-2 tracking-wide transition-colors duration-300 ${
        ...
        {/* Registrati — solo per la modalità staff */}
        {isLight && (
          <div className="mt-4">
            <div className="relative flex items-center justify-center mb-4">
              ...
              <span className="relative bg-white px-3 text-xs text-gray-400 font-medium uppercase tracking-wide">
                oppure
              </span>
            </div>
            <Link
              href="/register"
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 border-gray-200 text-gray-700 font-semibold text-sm hover:border-green-500 hover:text-green-600 hover:bg-green-50 transition-all duration-200"
            >
        ...
        <div className="mt-6 text-center">
          <Link
            ...
            className={`inline-flex items-center gap-2 text-sm transition-colors duration-300 ${
              isLight ? "text-gray-500 hover:text-green-600" : "text-gray-400 hover:text-purple-400"
            }`}
          >
